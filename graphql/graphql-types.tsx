...
export type MarketPlace_Item_DetailsQuery = {
  __typename?: "Query";
  marketPlace?: {
    __typename?: "MarketPlace";
    createdAt?: any | null;
    ...
    user?: {
      ...
      email?: string | null;
      name?: string | null;
      userImage?: { __typename?: "ImageFieldOutput"; url: string } | null;
    } | null;
  } | null;
};
 ...
 * });
 */
export function useMarketPlace_Item_DetailsQuery(
  baseOptions: Apollo.QueryHookOptions<
    MarketPlace_Item_DetailsQuery,
    MarketPlace_Item_DetailsQueryVariables
  >
) {
  ...
  return Apollo.useQuery<
    MarketPlace_Item_DetailsQuery,
    MarketPlace_Item_DetailsQueryVariables
  >(MarketPlace_Item_DetailsDocument, options);
}
export function useMarketPlace_Item_DetailsLazyQuery(
...
export type MarketPlace_Item_DetailsQueryHookResult = ReturnType<
  typeof useMarketPlace_Item_DetailsQuery
>;
export type MarketPlace_Item_DetailsLazyQueryHookResult = ReturnType<
  typeof useMarketPlace_Item_DetailsLazyQuery
>;
export type MarketPlace_Item_DetailsQueryResult = Apollo.QueryResult<
  MarketPlace_Item_DetailsQuery,
  MarketPlace_Item_DetailsQueryVariables
>;
 ...
 * });
 */
export function useSeller_ItemsQuery(
  baseOptions: Apollo.QueryHookOptions<
    Seller_ItemsQuery,
    Seller_ItemsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<Seller_ItemsQuery, Seller_ItemsQueryVariables>(
    Seller_ItemsDocument,
    options
  );
}
export function useSeller_ItemsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    Seller_ItemsQuery,
    Seller_ItemsQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<Seller_ItemsQuery, Seller_ItemsQueryVariables>(
    Seller_ItemsDocument,
    options
  );
}
export type Seller_ItemsQueryHookResult = ReturnType<
  typeof useSeller_ItemsQuery
>;
export type Seller_ItemsLazyQueryHookResult = ReturnType<
  typeof useSeller_ItemsLazyQuery
>;
export type Seller_ItemsQueryResult = Apollo.QueryResult<
  Seller_ItemsQuery,
  Seller_ItemsQueryVariables
>;
